      ...
      <div className="container mx-auto px-4">
        ...
        >
          <div className="text-center p-8 bg-white rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300">
            <h3 className="text-6xl font-bold text-primary mb-3">+1000</h3>
            <p className="text-gray-600 text-lg font-medium">{t('activeUsers')}</p>
          </div>
          <div className="text-center p-8 bg-white rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300">
            <h3 className="text-6xl font-bold text-primary mb-3">+50</h3>
            <p className="text-gray-600 text-lg font-medium">{t('cities')}</p>
          </div>
          <div className="text-center p-8 bg-white rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300">
            <h3 className="text-6xl font-bold text-primary mb-3">95%</h3>
